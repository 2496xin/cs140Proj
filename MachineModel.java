...
public class MachineModel {
	...
	public MachineModel(boolean withGUI, HaltCallback callback) {
        ...
        INSTRUCTIONS.put(0x6, arg -> cpu.incrementIP(arg));
        ...
        INSTRUCTIONS.put(0xA, arg -> {
        		if (cpu.accumulator == 0) cpu.incrementIP(memory.getData(cpu.memoryBase+arg));
        		else cpu.incrementIP(1);
        });
        ...
        INSTRUCTIONS.put(0x1D, arg -> callback.halt());
	}
